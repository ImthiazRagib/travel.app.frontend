export default function FlightSearch() {
    return (
        <section className="space-y-4">
            ...
            <form className="grid grid-cols-1 sm:grid-cols-4 gap-2 md:gap-4">
                ...
                <button className="sm:col-span-4 py-3 rounded text-white bg-blue-600 dark:bg-brand-600 focus:outline-none hover:ring-1 hover:ring-blue-500" type="button">Search</button>
            </form>
        </section>
    );
}